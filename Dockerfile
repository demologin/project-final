...
#EXPOSE 8080
#ENV DB_URL=jdbc:postgresql://postgres-spring-db-final:5432/jira
#ENTRYPOINT ["dockerize", "-wait", "tcp://postgres-spring-db-final:2345", "-timeout", "60s", "java", "-jar", "/app/jira-1.0.jar"]
