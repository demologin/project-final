...
import static com.javarush.jira.ref.ReferenceTestData.*;
...
public class ReferenceControllerWithContainerTest extends AbstractControllerTest {
    ...
    void create() throws Exception {
        ...
        ResultActions action = perform(MockMvcRequestBuilders.post(ReferenceController.REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(writeValue(new RefTo(null, RefType.TASK, "enhancement", "Enhancement", null, false))))
