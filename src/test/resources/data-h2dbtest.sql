...
from TASK;
alter
    table TASK alter column ID restart with 1;
delete
from SPRINT;
alter
    table SPRINT alter column ID restart with 1;
delete
from PROJECT;
alter
    table PROJECT alter column ID restart with 1;

delete
from USERS;
alter
    table USERS alter column ID restart with 1;
