...
public class TaskToExt extends TaskTo {
    ...
    public TaskToExt(Long id, String code, String title, String description, String typeCode,
                     String statusCode, String priorityCode, LocalDateTime updated,
                     Integer estimate, Long parentId, long projectId, Long sprintId, Set<String> tags) {
        super(id, code, title, typeCode, statusCode, parentId, projectId, sprintId, tags);
