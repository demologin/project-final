...
public class FileUtil {
    ...
    public static void upload(MultipartFile multipartFile, String directoryPath, String fileName) {
        ...
        try {
            ...
            Files.write(pathFile, multipartFile.getBytes(), StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING);
        } catch (IOException ex) {
            String errorMessage = String.format("Failed to upload file: %s", multipartFile.getOriginalFilename());
